...
from ainekio_motion.simulator_shim import MotionHub, build_motion_payload
...
class SimulatorShimTests(unittest.TestCase):
    ...
    def test_motion_hub_keeps_latest_payload_for_late_browser_connection(self) -> None:
        hub = MotionHub()
        ...
        self.assertEqual(hub.latest(), payload)
